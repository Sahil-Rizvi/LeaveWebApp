...
window.onclick = function(event) {
    ...
    $("#uploadButton").on('click', function() {	
        	$.ajax({
       	       ...
       	       url: '/LeaveWebApp/uploader/api/uploadform/notice',  // action attribute of form
        ...
        if(id){
        	...
        	$.ajax({
       	   ...
       	   // convert form data to json format
       	       data : {"id":id},
       	       success: function(response){
       	    	$("#noticeResult").text(response);
       	   		},
       	   		error: function(e){
       	   			$('#noticeResult').html("Error");
       	   		}
       	    });
        	
        }
        else{
         $("#noticeResult").text("Invalid values");
        }
