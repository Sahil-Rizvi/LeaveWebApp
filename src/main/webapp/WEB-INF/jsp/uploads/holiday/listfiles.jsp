...
<c:if test="${not empty holidayfiles}">
...
<c:if test="${empty holidayfiles}">
 No Holiday file found
</c:if>
...
window.onclick = function(event) {
    ...
    $("#uploadButton").on('click', function() {	
        	$.ajax({
       	       ...
       	       url: '/LeaveWebApp/uploader/api/uploadform/holiday',  // action attribute of form
