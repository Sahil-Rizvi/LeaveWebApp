...
<tr>
<td id="${d.id}" class="dept-name">${d.name}</td>
<td>
...
<div id="editForm" >
		<p><label for="oldDept">Old Name:</label>
  		<input type="text" id="oldDept" value="" readonly="readonly"/><br></p>
  		<p><label for="newDept">New Name:</label>
  		<input type="text" id="newDept" value=""/><br></p>
...
span.onclick = function() {
 ...
 if(document.getElementById("newDept")){
 	document.getElementById("newDept").value = "";
 }
 if(document.getElementById("oldDept")){
 	document.getElementById("oldDept").value = "";
 }
 $("#editResp").text("");
}
...
$("button[name='editButton']").on('click', function() {
	ele= $(this).closest('tr').find('.dept-name');
	var id = ele.attr('id');
	var name = ele.text();
	var form = document.getElementById("editForm");
         form.style.display="block";	
        if(document.getElementById("oldDept")){
 	document.getElementById("oldDept").value = name;
	}
...
$("button[name='editSubmit']").on('click', function() {
        var id = ele.attr('id');
	var oldDepartment = ele.text();
	alert(id);
	alert(oldDepartment);
        var newDepartment = "";
        if(document.getElementById("newDept")){
 	newDepartment=document.getElementById("newDept").value;
 	}
        // make ajax call
        if(oldDepartment && newDepartment){
        	...
        	$.ajax({
       	       ...
       	       url: '/LeaveWebApp/customAdmin/dept/edit',  // action attribute of form
       	   // convert form data to json format
       	       data : {"id":id,"oldDepartment":oldDepartment,"newDepartment":newDepartment},
...
$("button[name='deleteYes']").on('click', function() {
	...
	if(id && name){
    	...
    	$.ajax({
   	       type: 'POST', // method attribute of form
   	       url: '/LeaveWebApp/customAdmin/dept/delete',  // action attribute of form
   	   // convert form data to json format
   	       data : {"id":id,"department":name},
   	       success: function(response){
