...
window.onclick = function(event) {
    ...
    $("#uploadButton").on('click', function() {	
        	$.ajax({
       	       ...
       	       url: '/LeaveWebApp/uploader/api/uploadform/leavepolicy',  // action attribute of form
        ...
        if(id){
        	...
        	$.ajax({
       	   ...
       	   // convert form data to json format
       	       data : {"id":id},
       	       success: function(response){
       	    	$("#leavePolicyResult").text(response);
       	   		},
       	   		error: function(e){
       	   			$('#leavePolicyResult').html("Error");
       	   		}
       	    });
        	
        }
        else{
         $("#leavePolicyResult").text("Invalid values");
        }
