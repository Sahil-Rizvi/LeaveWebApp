...
public class LeaveRequestDTO {
	...
	public LeaveRequestDTO(String empId, int pageNumber, String fromWhen, String toWhen) {
		super();
		this.empId = empId;
	...
	public String toString() {
		return "LeaveRequest [empId=" + empId + ", pageNumber=" + pageNumber + ", fromWhen=" + fromWhen + ", toWhen="
				+ toWhen + "]";
	}
