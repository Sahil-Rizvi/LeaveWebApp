...
@Entity(name="admin_password_reset_token")
...
private static final int EXPIRATION = 2;
    ...
    public AdminPasswordResetToken(final String token, final AdminEntity user) {
        super();
        this.token = token;
        this.user = user;
        this.expiryDate = calculateExpiryDate(EXPIRATION);
	...
	public String toString() {
		return "AdminPasswordResetToken [id=" + id + ", token=" + token + ", expiryDate="
				+ expiryDate + "]";
	}
